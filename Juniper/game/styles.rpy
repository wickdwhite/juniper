...
define gui.text_font = gui.preference("font", "SometypeMono.ttf")
# The text font for buttons
define gui.interface_text_font = gui.preference("interface_font", "Texturina.ttf")
# The default size of in-game text
define gui.text_size = gui.preference("size", 30)
# The font for character names
define gui.name_text_font = gui.preference("name_font", "MeowScript.ttf")
# The size for character names
define gui.name_text_size = gui.preference("name_size", 50)
...
#transitions baybeeee
init:
    $ starTrans = ImageDissolve("gui/starTransition.png", 0.2, 9)

init:
    $ introtrans = ImageDissolve("gui/leaftrans.png", 4, 9)

init:
    $ reveal = ImageDissolve("gui/leaftrans.png", 0.2, 2)
