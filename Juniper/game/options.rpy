...
define config.name = _("Juniper")

## A short name for the game used for executables and directories in the built
## distribution. This must be ASCII-only, and must not contain spaces, colons,
## or semicolons.

define build.name = "Juniper"
...
define config.save_directory = "Juniper-2836452729"
...
define config.after_load_transition = introtrans


## Used when entering the main menu after the game has ended.

define config.end_game_transition = introtrans
...
define build.itch_project = "wickoi/Juniper"
